...
function menu() {
    const bagHTML = document.querySelector(".bx-menu");
...
function notificationInBag(db) {
    const amountProductsHTML = document.querySelector(".cartAmount");
...
function themes() {
    ...
    const eventIcomSum = document.querySelector(".sun");
    const eventIcomMoon = document.querySelector(".moon");
...
function filterShow(db) {
    ...
    showAllHTML.innerHTML = `Show all products`;
